...
\centering
\vspace*{0.5cm}
{\large AIDAMS - Research \& Emerging Topics\par}
{\large Final Project \par}
\vspace{1cm}
{\large January 2026\par}
\vspace{1.5cm}

{\huge\bfseries Carbon Transition Risk and Stranded Assets in the Global Copper Mining Industry\par}
\vspace{0.5cm}
{\large\bfseries \textit{A Multidimensional Quantitative Framework Using Satellite-Derived Emissions Data and Machine Learning Trajectories}\par}

\vspace{1.5cm}

{\Large\textbf{Alexis VANNSON}\par}
{\Large\textbf{Kerrian LE BARS}\par}
{\Large\textbf{Othmane MENKOR}\par}

\vspace{1cm}

{\large\itshape Under the supervision of Professor Hamada SALEH\par}

\vspace{2cm}

% Note: If centralesupelec.png is not found, this will cause a compilation error.
% Ensure the image is present in the repository.
\includegraphics[width=5cm]{centralesupelec.jpeg}

\vfill

{\Large\textit{Project Report}\par}
\vspace{0.3cm}
{\large CentraleSupélec | Université Paris-Saclay \& ESSEC Business School\par}
\end{titlepage}
...
For investors, the message is clear: the energy transition will be copper-intensive, but not all copper is created equal. Asset-level transparency---enabled by satellite monitoring and rigorous analysis---is the only reliable means of distinguishing between the mines of the future and the stranded assets of the past.

To facilitate the practical application of these findings, this study is accompanied by an interactive ESG Dashboard. This web-based interface allows stakeholders to explore asset-level risks through a geospatial mapping system, analyze corporate portfolio exposures, and simulate financial impacts across dynamic carbon pricing scenarios. By providing a high-resolution visualization of stranding thresholds and emission trajectories, the platform serves as a decision-support tool for climate-aligned capital allocation and strategic corporate engagement.

As carbon pricing becomes a global norm, the ability to identify and manage transition risk at the asset level will be a critical determinant of portfolio performance and climate impact.
